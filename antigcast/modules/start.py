...
inlinegc = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="ᴄʀᴇᴀᴛᴏʀ", url="https://t.me/RedflixHD"),
            InlineKeyboardButton(text="ᴄʜᴀɴɴᴇʟ", url="https://t.me/NProjectSTD")
        ]
    ]
)
...
inline = InlineKeyboardMarkup(
    [
        ...
        [
                    ...
                    InlineKeyboardButton(text="Channel", url="https://t.me/NProjectSTD")
        ]
    ]
)
