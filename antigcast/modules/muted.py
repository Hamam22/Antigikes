...
async def mute_handler(app: Bot, message: Message):
    ...
    try:
        ...
        print(f"Error getting user: {e}")  # Debugging statement
    ...
    try:
        ...
        print(f"Error muting user: {e}")  # Debugging statement
...
@Bot.on_message(filters.group & ~filters.private, group=70)
